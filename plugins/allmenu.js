...
let memek = { key: { remoteJid: 'status@broadcast', participant: '0@s.whatsapp.net' }, message: { orderMessage: { itemCount: 9999999999, status: 1, thumbnail: await conn.resize(await getBuffer(thumb),300,150), surface: 1, message: 'ᴍᴏɴɪᴄʜᴀꜱᴇʟꜰ ᴍᴜʟᴛɪᴅᴇᴠɪᴄᴇ', orderTitle: wm, sellerJid: '0@s.whatsapp.net' } } }
...
`.trimStart(),
  ...
  footer: '╰─── –',
  after: `ᴍᴏɴɪᴄʜᴀꜱᴇʟꜰ ᴀɪ ʙʏ ᴡɪʟʏ ᴋᴜɴ ${global.version}`,
}
  try {
 ...
 type: 'audioMessage',  
 ptt: true, contextInfo: { forwardingScore: 999, isForwarded: false, externalAdReply: {title: 'ᴍᴏɴɪᴄʜᴀꜱᴇʟꜰ ᴍᴜʟᴛɪᴅᴇᴠɪᴄᴇ', body: wm, sourceUrl: 'https://chat.whatsapp.com/LTYOWwDQ9xuHMQtCuGOEn4', thumbnail: await (await fetch(bjir)).buffer(),}}  
  }) 
    } catch (e) {
