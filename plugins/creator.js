...
let delay = time => new Promise(res => setTimeout(res, time))
  ...
  await conn.reply(m.chat, 'My Creator Wily Multidevice', fpayment)
...
seconds: 22,
fileLength: 22,
 ptt: true, contextInfo: { forwardingScore: 999, isForwarded: false, externalAdReply: {title: 'My Creator Wily', body: wm, sourceUrl: 'https://wa.me/6289688206739?text=hai+bang', thumbnail: await (await fetch(bjir)).buffer(),}} 
 })
